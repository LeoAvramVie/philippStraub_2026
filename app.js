...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    de: {
      ...
      profile_desc: "Seit über 30 Jahren ist Philipp Straub ein fundamentaler Bestandteil der internationalen elektronischen Musikszene. Als weltweit tourender Künstler verbindet er seine emotionalen Musikdarbietungen mit einer B2B-Rolle als führender Berater für Entertainment- und Hospitality-Marken weltweit.",
      ...
      consulting_role1: "",
      consulting_desc1: "Strategische Beratung bei der Kuration und Modernisierung ihrer globalen Events. Beratung zur globalen Geschäftsentwicklung mit Fokus auf Entertainment.",
      consulting_role2: "",
      consulting_desc2: "Mitgründer dieses Beratungs- und Talent-Buying-Unternehmens mit Sitz in Großbritannien, das weltweit mit erstklassigen Hospitality-Gruppen, Nightlife-Betreibern und Regierungsvertretern zusammenarbeitet.",
      ...
      modal_p1: "Ein Pionier der elektronischen Musikszene in Zentraleuropa, der seine Präsenz auf die ganze Welt ausgeweitet hat. Als internationaler DJ hat er über 100 Länder bereist und trat in renommierten Clubs sowie auf Festivals weltweit auf.",
    ...
    en: {
      ...
      profile_desc: "Since over 30 years, Philipp Straub is a fundamental part of the international electronic music scene. As a globally touring artist, he blends his emotional music performances with a B2B role as a leading consultant for entertainment and hospitality brands worldwide.",
      ...
      consulting_role1: "",
      consulting_desc1: "Strategic advising on the curation and modernization of their global events. Consulting on global business development with focus on entertainment.",
      consulting_role2: "",
      consulting_desc2: "Co-Founder of this consultancy & talent buying company which is based in U.K. but operates globally with top tier hospitality groups, nightlife operators and government representatives.",
      ...
      modal_p1: "A pioneer of the electronic music scene in Central Europe who expanded throughout the world. As an international DJ, he has traveled to over 100 countries and performed in renowned clubs as well as festivals worldwide.",
    ...
    ar: {
      ...
      profile_desc: "لأكثر من 30 عامًا، يعد فيليب شتراوب جزءًا أساسيًا من مشهد الموسيقى الإلكترونية الدولي. كفنان يجول العالم، يدمج عروضه الموسيقية العاطفية مع دور B2B كمستشار رائد لعلامات الترفيه والضيافة في جميع أنحاء العالم.",
      ...
      consulting_desc1: "تقديم الاستشارات الاستراتيجية حول تنظيم وتحديث فعالياتهم العالمية. تقديم الاستشارات حول تطوير الأعمال العالمية مع التركيز على الترفيه.",
      consulting_role2: "",
      consulting_desc2: "شريك مؤسس لشركة الاستشارات وشراء المواهب هذه ومقرها في المملكة المتحدة، ولكنها تعمل على مستوى عالمي مع مجموعات الضيافة من الدرجة الأولى ومشغلي الحياة الليلية والممثلين الحكوميين.",
    ...
    hi: {
      ...
      profile_desc: "30 से अधिक वर्षों से, फिलिप स्ट्रॉब अंतर्राष्ट्रीय इलेक्ट्रॉनिक संगीत परिदृश्य का एक मौलिक हिस्सा हैं। एक वैश्विक स्तर पर दौरा करने वाले कलाकार के रूप में, वह अपने भावनात्मक संगीत प्रदर्शन को दुनिया भर में मनोरंजन और आतिथ्य ब्रांडों के लिए एक अग्रणी सलाहकार के रूप में एक B2B भूमिका के साथ जोड़ते हैं।",
      ...
      consulting_desc1: "उनके वैश्विक कार्यक्रमों के क्यूरेशन और आधुनिकीकरण पर रणनीतिक सलाह। मनोरंजन पर ध्यान देने के साथ वैश्विक व्यापार विकास पर परामर्श।",
      consulting_role2: "",
      consulting_desc2: "इस परामर्श और प्रतिभा खरीद कंपनी के सह-संस्थापक, जो यू.के. में स्थित है, लेकिन शीर्ष स्तर के आतिथ्य समूहों, नाइटलाइफ़ ऑपरेटरों और सरकारी प्रतिनिधियों के साथ वैश्विक स्तर पर काम करती है।",
    ...
    zh: {
      ...
      profile_desc: "30多年来，Philipp Straub一直是国际电子音乐界不可或缺的一部分。作为一名全球巡演艺术家，他将富有情感的音乐现场与作为全球娱乐和酒店品牌领先顾问的B2B角色完美融合。",
      profile_bio_btn: "阅读个人传记 ➔",
      music_title: "音乐与现场",
      consulting_title: "夜生活规划师",
      consulting_intro: "Philipp 在俱乐部文化与奢华酒店业的交汇处为全球客户提供咨询。",
      consulting_role1: "音乐总监",
      consulting_desc1: "针对其全球活动的策划与现代化提供战略咨询。专注于娱乐领域的全球业务发展咨询。",
      consulting_role2: "",
      consulting_desc2: "这家咨询与人才采购公司的联合创始人。该公司总部位于英国，但在全球范围内与顶尖的款待业集团、夜生活运营商及政府代表合作。",
      gigs_title: "巡演日程",
      gigs_th_date: "日期",
      gigs_th_venue: "场地",
